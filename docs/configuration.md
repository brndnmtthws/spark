...
<tr>
  ...
  <td>0.15, with minimum of 384MiB</td>
  <td>
    This is the fraction of <code>spark.executor.memory</code> which is used for
    the Mesos task memory.  For example, a value of <code>0.15</code> implies
    a 15% overhead.
  </td>
</tr>
</table>
